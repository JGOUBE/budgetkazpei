...
const CONTENT = {
  fr: {
    ...
    features: {
      ...
      pillars: [
        { title: "Mon budget", answer: "Revenus, dépenses, solde, alertes et statistiques.", points: ["Solde du mois", "Dépenses classées"], tone: "cream", icon: "budget", visual: "budget", fragment: { metricLabel: "Solde du mois", metric: LANDING_DEMO_DATA.remaining, secondaryLabel: "Dépenses du mois", secondary: LANDING_DEMO_DATA.expenses } },
  ...
  kr: {
    ...
    features: {
      ...
      pillars: [
        { title: "Mon bidjé", answer: "Larzan i rantre, dépans, larzan i reste, alèrt ek statistik.", points: ["Larzan i reste", "Dépans klasé"], tone: "cream", icon: "budget", visual: "budget", fragment: { metricLabel: "Larzan i reste", metric: LANDING_DEMO_DATA.remaining, secondaryLabel: "Dépans lo mwa", secondary: LANDING_DEMO_DATA.expenses } },
