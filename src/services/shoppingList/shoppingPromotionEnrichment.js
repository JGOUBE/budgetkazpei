...
function promotionSnapshot(promotion) {
  ...
  return {
    ...
    rawPromoPrice: moneyOrNull(promotion.rawPromoPrice),
    smartPriceValue: moneyOrNull(promotion.smartPriceValue),
    smartPriceUnitLabel: promotion.smartPriceUnitLabel || "",
