...
const DETAILS: Record<ScanErrorCode, ScanErrorDetails> = {
  SCAN_IMAGE_TOO_LARGE: {
    ...
    userMessage: "L'image est trop lourde pour être analysée correctement.",
    technicalMessage: "Input image exceeds the accepted scanner size.",
    action: "Reprenez une photo plus simple ou importez une image plus légère.",
    retryable: true,
  },
  SCAN_IMAGE_UNREADABLE: {
    ...
    action: "Reprenez une photo nette, bien cadrée et bien éclairée.",
    retryable: true,
  },
  SCAN_OCR_FAILED: {
    code: "SCAN_OCR_FAILED",
    title: "Lecture du ticket impossible",
    userMessage: "Le texte du ticket n'a pas pu être lu.",
    technicalMessage: "OCR provider failed or returned no text.",
    action: "Réessayez ou remplissez le ticket manuellement.",
    retryable: true,
  },
  SCAN_OCR_TIMEOUT: {
    code: "SCAN_OCR_TIMEOUT",
    title: "Lecture trop longue",
    userMessage: "Le service d'analyse met trop de temps à répondre.",
    technicalMessage: "OCR request timed out.",
    action: "Réessayez dans quelques instants ou remplissez le ticket manuellement.",
    retryable: true,
  },
  SCAN_OPENAI_KEY_MISSING: {
    code: "SCAN_OPENAI_KEY_MISSING",
    title: "Configuration IA absente",
    userMessage: "Le scanner IA n'est pas encore configuré côté serveur.",
    technicalMessage: "OPENAI_API_KEY is missing in the Supabase Edge Function environment.",
    action: "Ajoutez OPENAI_API_KEY dans les secrets Supabase puis redéployez la fonction scan-receipt-ocr.",
    retryable: false,
  },
  SCAN_OPENAI_KEY_INVALID: {
    code: "SCAN_OPENAI_KEY_INVALID",
    title: "Clé IA invalide",
    userMessage: "La clé du service IA est invalide ou refusée.",
    technicalMessage: "OPENAI_API_KEY was rejected by OpenAI.",
    action: "Vérifiez et remplacez OPENAI_API_KEY dans les secrets Supabase puis redéployez la fonction scan-receipt-ocr.",
    retryable: false,
  },
  SCAN_OPENAI_REQUEST_INVALID: {
    code: "SCAN_OPENAI_REQUEST_INVALID",
    title: "Requête IA invalide",
    userMessage: "Le service IA a refusé la demande envoyée par le scanner.",
  ...
  SCAN_OPENAI_REQUEST_FAILED: {
    ...
    userMessage: "Le service de scan a rencontré une erreur technique. Réessayez dans un instant.",
    technicalMessage: "OpenAI or Supabase Edge Function request failed.",
    action: "Réessayez dans quelques instants ou passez en saisie manuelle.",
    retryable: true,
  },
  SCAN_OPENAI_QUOTA_EXCEEDED: {
  ...
  SCAN_AI_RESPONSE_INVALID: {
    ...
    action: "Réessayez avec une photo plus nette ou remplissez manuellement.",
    retryable: true,
  },
  SCAN_PARSE_FAILED: {
    code: "SCAN_PARSE_FAILED",
    title: "Vérification nécessaire",
    userMessage: "Nous avons lu le ticket, mais certaines lignes doivent être vérifiées.",
    technicalMessage: "Receipt parser failed to extract usable fields.",
    action: "Vous pouvez réessayer avec une photo plus nette ou compléter les lignes détectées.",
    retryable: true,
  },
  SCAN_SUPABASE_INSERT_FAILED: {
    code: "SCAN_SUPABASE_INSERT_FAILED",
    title: "Enregistrement impossible",
    userMessage: "Le ticket n'a pas pu être enregistré.",
    technicalMessage: "Supabase insert or update failed.",
    action: "Vérifiez les migrations receipts, shopping_items et scan_usage.",
    retryable: true,
  },
  SCAN_DUPLICATE_RECEIPT: {
    code: "SCAN_DUPLICATE_RECEIPT",
    title: "Ticket déjà importé",
    userMessage: "Ce ticket ressemble à un ticket déjà enregistré.",
    technicalMessage: "Duplicate receipt heuristic matched existing receipt.",
    action: "Choisissez Importer quand même ou annulez.",
    retryable: false,
  },
  SCAN_NETWORK_OFFLINE: {
