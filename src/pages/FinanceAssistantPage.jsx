...
const TEXT = {
  fr: {
    ...
    title: "Mon assistant",
    subtitle: "Pose une question sur tes depenses, magasins, produits ou economies possibles.",
    prompts: [
      "Pourquoi ai-je depense plus ce mois-ci ?",
      "Quels magasins me coutent le moins cher ?",
      "Comment economiser 100 EUR ?",
  ...
  kreol: {
    ...
    title: "Mon asistan",
    subtitle: "Poz in kestion su out depans, magasins, produits ou lekonomi possible.",
    prompts: [
      "Poukosa mi depense plis sa mwa-la ?",
      "Ki magasins i coute moins cher pou moin ?",
      "Koman economise 100 EUR ?",
      "Poukosa mon bidze manze i augmente ?",
    ],
    placeholder: "Ecris out kestion...",
    ask: "Domande",
    busy: "Analiz...",
  },
}
