...
function BudgetVisual() {
  return (
    <div className="pillar-visual pillar-visual--budget" aria-hidden="true">
      <div className="pillar-visual__score"><strong>82</strong><span>/ 100</span><em>Correct</em></div>
...
function CoursesVisual() {
  return (
    <div className="pillar-visual pillar-visual--courses" aria-hidden="true">
      <div className="pillar-visual__receipt-head"><BkIcons.receipts size={15} /><span>Ticket vérifié</span><b>8</b></div>
      <div className="pillar-visual__receipt-row"><span>Produits du quotidien</span><b>84,20 €</b></div>
      <div className="pillar-visual__receipt-row"><span>Articles reconnus</span><b>100 %</b></div>
      <div className="pillar-visual__receipt-line" />
      <div className="pillar-visual__receipt-total"><span>Total ajouté au budget</span><strong>84,20 €</strong></div>
    </div>
  )
}
...
export default function LandingPillar({ benefit, index }) {
  ...
  return (
    <article className={`landing-pillar landing-pillar--${benefit.visual} landing-pillar--index-${index}`}>
