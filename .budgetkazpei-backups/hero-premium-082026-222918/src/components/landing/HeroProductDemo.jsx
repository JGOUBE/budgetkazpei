  ...
  return (
    <div className="hero-product-demo" aria-label={copy.ariaLabel}>
      ...
      <div className="hero-product-demo__stage">
        ...
        <ProductPhoneMockup premiumAsset="/landing-reference/premium-phone-dashboard.png" referenceImage={copy.referenceImage} imageAlt="Tableau de bord BudgetKazPéi" variant="hero" />
