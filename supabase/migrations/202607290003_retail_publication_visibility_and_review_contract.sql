...
retail_promotions as (
  select
    ...
    coalesce(catalogs.scope_type::text::public.good_deal_scope_type, 'commune'::public.good_deal_scope_type) as scope_type,
...
retail_observed_prices as (
  select
    ...
    'shopping'::text as category,
    'commune'::public.good_deal_scope_type as scope_type,
