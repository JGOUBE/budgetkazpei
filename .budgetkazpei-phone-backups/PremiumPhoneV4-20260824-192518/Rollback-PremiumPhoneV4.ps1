...
$backup = 'C:\Users\Jack.LAPTOP-2USDKF0K\budgetkazpei\.budgetkazpei-phone-backups\PremiumPhoneV4-20260824-192518'
...
Write-Host 'Rollback PremiumPhone V4 termine.' -ForegroundColor Green
