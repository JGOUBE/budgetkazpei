...
const CONTENT = {
  fr: {
    ...
    features: {
      ...
      pillars: [
        { eyebrow: "Mon budget", title: "Gardez votre budget sous contrôle.", answer: "Voyez en un coup d’œil où part votre argent.", points: ["Alimentaire · 33 %", "Logement · 51 %"], tone: "cream", icon: "budget", visual: "budget", fragment: { ariaLabel: "Répartition des dépenses", title: "Répartition des dépenses", hint: "Touchez une catégorie pour la mettre en avant.", categories: [{ label: "alimentaire", percent: "33 %", amount: "346,54 €", color: "#ff7012" }, { label: "logement", percent: "51 %", amount: "529,50 €", color: "#3eb7ed" }, { label: "énergie", percent: "11 %", amount: "115,00 €", color: "#ffd04a" }] } },
        { eyebrow: "Mes courses", title: "Préparer ses courses devient plus simple.", answer: "Retrouvez vos tickets, suivez vos habitudes d’achat et préparez votre liste de courses directement dans BudgetKazPéi.", points: ["Liste de courses", "Partage rapide"], tone: "blue", icon: "shopping", visual: "courses", fragment: { ticketLabel: "Dernier ticket", ticketValue: "186,40 €", listTitle: "Ma liste de courses", listItems: ["Riz", "Lait", "Yaourts", "Poulet", "Lessive"], itemStatus: "À prévoir", share: "Partager la liste", shareMeta: "WhatsApp · Messages · autres applications", itemCountSuffix: "articles" } },
        { title: "Mes aides & démarches", answer: "Aides possibles, informations utiles et suivi des démarches.", points: ["Documents", "Prochaine action"], tone: "lavender", icon: "aides", visual: "aides", fragment: { steps: ["À vérifier", "Documents", "Envoyé"], activeStep: 1, nextLabel: "Prochaine action", next: "Vérifier les conditions", nextMeta: "BudgetKazPéi vous aide à préparer, l'organisme décide." } },
    ...
    advisor: {
      eyebrow: "Conseiller BudgetKazPéi", title: "Des réponses utiles, à partir de votre quotidien.",
      intro: "Le conseiller s’appuie sur les informations disponibles dans BudgetKazPéi pour vous aider à mieux comprendre votre situation et avancer plus facilement dans vos démarches.",
      conversation: {
    ...
    localDeals: {
      promotions: {
        eyebrow: "Promos du moment", title: "Les promotions près de chez vous.", text: "Retrouvez les promotions en cours et les catalogues disponibles autour de votre commune.",
        cards: [
          { icon: "catalog", badge: "Près de chez vous", title: "Promotions du moment", text: "Catalogue et période disponibles dans BudgetKazPéi.", meta: "Contenu local à consulter dans l’application", tone: "peach" },
          { icon: "shopping", badge: "À consulter", title: "Catalogues à consulter", text: "Préparez vos courses à partir des offres disponibles près de chez vous.", meta: "Retrouvez les informations disponibles dans BudgetKazPéi", tone: "blue" },
        ],
      },
      localOffers: {
        eyebrow: "Autour de vous", title: "Des offres utiles autour de vous.", text: "Repérez plus facilement les commerces, services et bons plans disponibles dans votre secteur.", categoriesAriaLabel: "Types d’offres locales",
        categories: [
      ...
      family: {
        eyebrow: "Sorties & famille", title: "Des idées pour profiter de La Réunion en famille.", text: "Événements, sorties et activités à retrouver près de chez vous, avec des idées adaptées à tous les budgets.",
    ...
    finalCta: {
      ...
      text: "Budget, courses, aides, démarches et bons plans réunis dans une application pensée pour le quotidien à La Réunion.",
  ...
  kr: {
    ...
    features: {
      ...
      pillars: [
        { eyebrow: "Mon bidjé", title: "Gard out bidjé anba kontrol.", answer: "Gad an in sèl kou d’œil kot out larzan i sava.", points: ["Manzé · 33 %", "Lozman · 51 %"], tone: "cream", icon: "budget", visual: "budget", fragment: { ariaLabel: "Koman dépans i reparti", title: "Koman dépans i reparti", hint: "Toush in kategori pou met ali an avan.", categories: [{ label: "manzé", percent: "33 %", amount: "346,54 €", color: "#ff7012" }, { label: "lozman", percent: "51 %", amount: "529,50 €", color: "#3eb7ed" }, { label: "énerzi", percent: "11 %", amount: "115,00 €", color: "#ffd04a" }] } },
        { eyebrow: "Mon bann courses", title: "Prépar out courses i devien pli senp.", answer: "Retrouv out bann tiké, suiv out bann labitid d'achat ek prépar out list courses dann BudgetKazPéi.", points: ["List courses", "Partaz vit"], tone: "blue", icon: "shopping", visual: "courses", fragment: { ticketLabel: "Dernyé tiké", ticketValue: "84,20 €", listTitle: "Mon list courses", listItems: ["Riz", "Lait", "Yaourts", "Poulet", "Lessive"], itemStatus: "Pou prévoir", share: "Partaz la list", shareMeta: "WhatsApp · Messages · bann ot aplikasyon", itemCountSuffix: "artik" } },
        { title: "Mon bann èd ek demars", answer: "Bann èd posib, ransèyman itil ek swiv out bann demars.", points: ["Dokiman", "Proshin aksyon"], tone: "lavender", icon: "aides", visual: "aides", fragment: { steps: ["A vérifier", "Dokiman", "Envoyé"], activeStep: 1, nextLabel: "Proshin aksyon", next: "Vérifié bann kondisyon", nextMeta: "BudgetKazPéi i aide aou prépar, organisme-la i désid." } },
    ...
    localDeals: {
      promotions: {
        eyebrow: "Promosyon dann moman", title: "Bann promosyon près koté ou.", text: "Retrouv bann promosyon an kour ek bann katalog disponib otour out kominn.",
        cards: [
          { icon: "catalog", badge: "Près koté ou", title: "Promosyon dann moman", text: "Katalog ek périod disponib dann BudgetKazPéi.", meta: "Konteni lokal pou gad dann aplikasyon-la", tone: "peach" },
          { icon: "shopping", badge: "Pou konsilté", title: "Katalog pou konsilté", text: "Prépar out courses avek bann lof disponib près koté ou.", meta: "Retrouv bann ransèyman disponib dann BudgetKazPéi", tone: "blue" },
        ],
      },
      localOffers: {
        eyebrow: "Otour ou", title: "Bann lof itil otour ou.", text: "Repèr pli fasil bann komers, servis ek Bon Plan disponib dann out sektèr.", categoriesAriaLabel: "Bann kalite lof lokal",
        categories: [
      ...
      family: {
        eyebrow: "Sorti ek famiy", title: "Bann lidé pou profite La Rényon an famiy.", text: "Evennman, sorti ek aktivité pou retrouv près koté ou, avek bann lidé adapté pou tout bidjé.",
    ...
    finalCta: {
      eyebrow: "Pensé pou La Rényon", title: "La vi péi, dann in sèl landrwa.", text: "Bidjé, courses, èd, demars ek Bon Plan rasanblé dann in aplikasyon pansé pou la vi La Rényon.", languageLine: "Français ek Kréol rényoné", freeLabel: "Gratis pou koumansé", primaryGuest: "Kré mon kont gratis", primaryAuthenticated: "Alé dann BudgetKazPéi", secondary: "Dékouv bann lof",
    },
    pricing: {
