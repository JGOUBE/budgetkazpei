...
- batch_id: alias-auto-e-leclerc-002
- date: 2026-08-06T18:47:32.544Z
- source_mode: file
...
| open_food_facts_search | 503 | external_fetch_failed:open_food_facts_search:503:3:https://world.openfoodfacts.org/cgi/search.pl?search_terms=OLIVE%20VRT%20DEN&search_simple=1&action=process&json=1&page_size=8 | 1 | 3 | 0 | OLIVE VRT DEN |
...
```bash
node scripts/enrich_market_alias_candidates.mjs --from-file C:\Users\Jack.LAPTOP-2USDKF0K\budgetkazpei\reports\alias-auto-e-leclerc-002-input.json --store-chain "e leclerc" --limit 20 --offset 0 --batch-id alias-auto-e-leclerc-002 --dry-run --report C:\Users\Jack.LAPTOP-2USDKF0K\budgetkazpei\reports\alias-auto-e-leclerc-002.json
```
