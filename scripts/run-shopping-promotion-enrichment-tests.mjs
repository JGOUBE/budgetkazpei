...
assert.match(page, /getShoppingAutocompleteSuggestions\(query, shoppingItems, retailPromotions, retailObservedPrices\)/)
assert.match(page, /loadPublishedRetailObservedPrices\(\{ client: supabase \}\)/)
assert.match(page, /data-shopping-suggestion-group="observed"/)
