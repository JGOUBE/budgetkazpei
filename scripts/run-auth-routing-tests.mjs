...
const cases = [
  ...
  ["guest discover is public home", route(DISCOVER_ROUTE), { type: "render", page: "home" }],
  ["known logged-out discover stays public home", route(DISCOVER_ROUTE, { hasAuthenticatedBefore: true }), { type: "render", page: "home" }],
  ...
  ["connected discover redirects app", route(DISCOVER_ROUTE, { isAuthenticated: true }), { type: "redirect", to: APP_ROUTE, replace: true }],
