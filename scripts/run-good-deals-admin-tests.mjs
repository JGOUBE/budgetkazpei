...
assert.match(retailMigration, /'observed_price'::text as content_kind/, "Retail migration must preserve the observed-price public content kind")
assert.match(retailMigration, /'promotion'::text as content_kind/, "Retail migration must preserve the promotion public content kind")
...
assert.match(retailMigration, /gd\.scope_type::text as scope_type/, "The base branch must keep the public view scope_type contract as text")
assert.match(retailMigration, /gd\.deal_type::text as deal_type/, "The base branch must keep the public view deal_type contract as text")
assert.match(retailMigration, /gd\.content_kind::text as content_kind/, "The base branch must keep the public view content_kind contract as text")
